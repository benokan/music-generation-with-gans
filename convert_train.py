...
converter_path = os.path.join(ROOT_PATH, 'SuperMarioMidi_train/converter')
cleaner_path = os.path.join(ROOT_PATH, 'SuperMarioMidi_train/cleaner')
...
def main():
    ...
    midi_paths = get_midi_path(os.path.join(ROOT_PATH, 'SuperMarioMidi_train/origin_midi'))
    midi_dict = {}
    ...
    with open(os.path.join(ROOT_PATH, 'SuperMarioMidi_train/midis.json'), 'w') as outfile:
        json.dump(midi_dict, outfile)

    print("[Done] {} files out of {} have been successfully converted".format(len(midi_dict), len(midi_paths)))

    with open(os.path.join(ROOT_PATH, 'SuperMarioMidi_train/midis.json')) as infile:
